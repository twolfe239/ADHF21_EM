...
#define enc28j60_select() HAL_GPIO_WritePin(ENC28J60_CS_PORT, ENC28J60_CS_PIN, RESET)
#define enc28j60_release() HAL_GPIO_WritePin(ENC28J60_CS_PORT, ENC28J60_CS_PIN, SET)
...
uint8_t enc28j60_rxtx(uint8_t TxByte)
{
	uint8_t RxByte;
	HAL_SPI_TransmitReceive(&SPI_PORT, &TxByte, &RxByte,1,0x1000);
	  return RxByte;
}
